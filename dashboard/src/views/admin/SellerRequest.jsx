                ...
                <div className='relative overflow-x-auto'>
                    <table className='w-full text-sm text-left text-[#283046]'>
                        ...
                        <tbody className='text-sm font-normal'>
                            {
                                sellers.map((d, i) => <tr className='border-b border-[#AFE1AF]' key={i}>
                                    ...
                                    <td scope='row' className='py-2 px-4 font-normal whitespace-nowrap'>
                                        <div className='flex justify-start items-center gap-4'>
                                            <Link to={`/admin/dashboard/seller/details/${d._id}`} className='p-[6px] bg-[#FFC300] rounded hover:bg-[#E57F84] transition duration-300'>
