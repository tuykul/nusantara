...
const SellerDashboard = () => {
    ...
    const state = {
        series: [
            {
                name: "Total Pesanan",
                data: [78, 65, 34, 65, 34, 34, 34, 56, 23, 67, 23, 45]
            },
            {
                name: "Total produk",
            ...
            {
                name: "Total Batal produk",
                data: [20, 10, 5, 1, 4, 4, 5, 10, 7, 3, 4, 5]
            }
        ],
        options: {
            chart: {
            ...
            colors: ['#FFC300', '#AFE1AF', '#E57F84','#900000'],
            xaxis: {
            ...
            <div className='flex justify-between items-center'>
                <div>
                    ...
                    <h2 className='text-3xl font-bold text-[#283046] mt-2'>
                        {title.includes('Total Penjualan') ? `Rp ${value.toLocaleString('id-ID')}` : value}
                    </h2>
                </div>
        ...
        <div className='p-4 md:p-6 bg-[#F9F6EE]'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 mt-6'>
                ...
                <div className='lg:col-span-2 bg-white p-4 rounded-lg shadow-sm border border-[#AFE1AF]/20'>
                    <div className='flex justify-between items-center mb-4'>
                        <h2 className='text-lg font-semibold text-[#283046]'>Pesan Pelanggan</h2>
            ...
            <div className='mt-6 bg-white p-4 rounded-lg shadow-sm border border-[#AFE1AF]/20'>
                <div className='flex justify-between items-center mb-4'>
                    ...
                    <Link to='/seller/dashboard/orders' className='text-[#FFC300] hover:underline text-sm'>
                        Lihat Semua
                    </Link>
                </div>
