...
const Details = () => {
    ...
    return (
        <div className='bg-[#F9F6EE] text-[#283046]'>
            ...
            <div className='bg-[#F9F6EE] py-5 mb-5'>
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    <div className='flex justify-start items-center text-md text-[#283046] w-full'>
                        <Link to='/' className='hover:text-[#FFC300]'>Home</Link>
                        <span className='pt-1'><MdOutlineKeyboardArrowRight /></span>
                        <Link to='/' className='hover:text-[#FFC300]'>{product.category}</Link>
                        <span className='pt-1'><MdOutlineKeyboardArrowRight /></span>
            ...
            <section>
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16'>
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        <div>
                            <div className='p-5 border border-[#AFE1AF] rounded-lg'>
                                <img className='h-[500px] w-full object-cover rounded-md' src={image ? image : product.images?.[0]} alt="" />
                            </div>
                            <div className='py-3'>
                                ...
                                >
                                    {product.images.map((img, i) => (
                                        <div key={i} onClick={() => setImage(img)} className='px-2'>
                                            <img className='h-[120px] w-full object-cover cursor-pointer rounded-md border border-[#AFE1AF] hover:border-[#FFC300]' src={img} alt="" />
                                        </div>
                                    ))}
                                </Carousel>}
                            </div>
                        ...
                        <div className='flex flex-col gap-5'>
                            <div className='text-3xl text-[#283046] font-bold'>
                                <h2>{product.name}</h2>
                            </div>
                            ...
                            <div className='text-2xl text-[#FFC300] font-bold flex gap-3'>
                                {product.discount !== 0 ? (
                                    <>
                                        <h2 className='line-through text-gray-500'>Rp{product.price}</h2>
                                        <h2>Rp{product.price - Math.floor((product.price * product.discount) / 100)} (-{product.discount}%)</h2>
                                    </>
                                ) : (
                            ...
                            <div className='flex gap-3 pb-10 border-b border-[#AFE1AF]'>
                                {product.stock ? (
                                    <>
                                        <div className='flex bg-[#F9F6EE] border border-[#AFE1AF] h-[50px] justify-center items-center text-xl rounded-md'>
                                            <div onClick={dec} className='px-6 cursor-pointer hover:text-[#FFC300]'>-</div>
                                            <div className='px-5'>{quantity}</div>
                                            <div onClick={inc} className='px-6 cursor-pointer hover:text-[#FFC300]'>+</div>
                                        </div>
                                        <div>
                                            <button 
                                                onClick={add_card} 
                                                className='px-8 py-3 h-[50px] cursor-pointer rounded-md 
                                                bg-[#AFE1AF] text-[#283046] 
                                                hover:bg-[#FFC300] transition-colors duration-300'
                                            >
                                                Add To Cart
                                            </button>
                                        </div>
                                ...
                                <div>
                                    <div 
                                        ...
                                        rounded-md bg-[#AFE1AF] text-[#283046] 
                                        hover:bg-[#FFC300] transition-colors duration-300'
                                    >
                                        <AiFillHeart />
                                    </div>
                                            ...
                                            return (
                                                <Link className='block'>
                                                    ...
                                                    <div className='flex gap-2'>
                                                        <h2 className='text-[#6699ff] text-lg font-bold'>Rp{p.price}</h2>
