                                            ...
                                            p.products.map((pt, j) => <div key={i + 99} className='w-full flex flex-wrap'>
                                                ...
                                                <div className='flex justify-end w-5/12 sm:w-full sm:mt-3'>
                                                    <div className='pl-4 sm:pl-0'>
                                                        <h2 className='text-lg text-orange-500'>Rp{pt.productInfo.price - Math.floor((pt.productInfo.price * pt.productInfo.discount) / 100)}</h2>
                                                        <p className='line-through'>Rp{pt.productInfo.price}</p>
                            ...
                            <div className="pl-3 md-lg:pl-0">
                                <div className='bg-white font-medium p-5 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <div className='flex justify-between items-center'>
                                        ...
                                        <span>Rp{price + shipping_fee}</span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                        <span>Total</span>
                                        <span>Rp{price + shipping_fee}</span>
